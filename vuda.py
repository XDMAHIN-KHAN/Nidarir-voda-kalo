...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/XDMAHIN-KHAN/Nidarir-voda-kalo/blob/main/voda.txt"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGERhttps://www.facebook.com/profile.php?id=100091734259249")
	subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100091734259249"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/XDMAHIN-KHAN/Nidarir-voda-kalo/blob/main/voda.txt').text
			if basesplit in plr:
				key = basesplit
